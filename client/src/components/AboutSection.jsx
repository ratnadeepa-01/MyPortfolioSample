...
export const AboutSection = () => {
  ...
  const socialLinks = [
    { icon: <Github className="h-5 w-5" />, href: "https://github.com/ratnadeepa-01" },
    { icon: <Linkedin className="h-5 w-5" />, href: "https://www.linkedin.com/in/ratnadeepa-kesavan-6a8407293/" },
    { icon: <Twitter className="h-5 w-5" />, href: "#" },
    { icon: <Mail className="h-5 w-5" />, href: "ratnadeepakesavan@gmail.com" }
  ];
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="relative flex-shrink-0">
                    <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-2xl overflow-hidden border-4 border-primary/20 shadow-2xl transition-all duration-500 group-hover:border-primary/40 group-hover:scale-105 md:group-hover:scale-110 relative">
                      <img src="" alt="MD Sahil" className="w-full h-full object-cover" />
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2">Ratnadeepa K P</h2>
